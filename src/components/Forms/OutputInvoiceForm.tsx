...
export const OutputInvoiceForm: React.FC<OutputInvoiceFormProps> = ({
  isOpen,
  onClose,
  onSubmit,
  initialData,
    ...
    ? ReactDOM.createPortal(
        ...
        >
          ...
          >
            ...
            >
              Tem certeza que deseja registrar esta Nota SEM gerar os títulos financeiros? As
              obrigações no Contas a Receber não serão criadas automaticamente.
            </p>
      ...
      >
          ...
          >
            <div className="tauze-field-group">
              <label className="tauze-label">
                <Building2 size={14} /> Empresa / Unidade Vendedora
              </label>
              <SearchableSelect
            ...
            <div className="tauze-field-group">
              <label className="tauze-label">
                <Settings size={14} /> Natureza da Operação (CFOP)
              </label>
              <SearchableSelect
                ...
                options={[
                  ...
                  {
                    value: 'Venda de Mercadoria Terceiros',
                    label: 'Venda de Mercadoria Terceiros',
                  },
                  {
                    value: 'Remessa para Industrialização',
                    label: 'Remessa para Industrialização',
                  },
            ...
            <div className="tauze-field-group">
              <label className="tauze-label">
                <User size={14} /> Parceiro / Destinatário
              </label>
              <SearchableSelect
        ...
        <section className="tauze-form-section">
          ...
          <div className="tauze-input-grid grid-col-4">
            ...
            <div className="tauze-field-group">
              <label className="tauze-label">
                <Package size={14} /> Frete por Conta
              </label>
              <SearchableSelect
            ...
            <div className="tauze-field-group">
              <label className="tauze-label">
                <Scale size={14} /> Peso Bruto Total (Kg)
              </label>
              <input
                className="tauze-input"
                type="number"
            ...
            {pendingMatches > 0 && (
              ...
              >
                ...
                <span style={{ fontSize: '12px', fontWeight: 700, color: '#dc2626' }}>
                  ...
                  com o catálogo â€” resolva antes de transmitir a NF-e.
                </span>
              </div>
            )}
          </div>
        ...
        <section className="tauze-form-section">
          ...
          >
            ...
            <div className="tauze-field-group">
              <label className="tauze-label">
                <Wallet size={14} /> Conta de Destino
              </label>
              <SearchableSelect
              ...
              <label
                style={{
                  ...
                  border: isFinancialDisabledByOrder
                    ...
                    : '1px dashed hsl(var(--success)/0.3)',
        ...
        <section className="tauze-form-section">
          ...
          <div className="tauze-input-grid grid-col-1">
            <div className="tauze-field-group">
              <label className="tauze-label">
                <FileText size={14} /> Dados Adicionais
              </label>
              <textarea
