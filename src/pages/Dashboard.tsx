...
export const Dashboard: React.FC = () => {
  ...
  const getActivityIcon = (entity: string) => {
    switch (entity?.toLowerCase()) {
      case 'animais': return Beef;
      case 'lotes': return LandPlot;
      case 'contas_pagar':
      case 'contas_receber': return DollarSign;
  ...
  const getStatIcon = (id: string) => {
    switch (id) {
      case 'gmd': return Activity;
      case 'lotacao': return PieChart;
      case 'caixa': return DollarSign;
      case 'rebanho': return Beef;
      default: return Zap;
    }
  };
