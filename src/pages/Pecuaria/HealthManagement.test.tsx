      ...
      data: [
        {
          ...
          dose: '5ml',
          via_aplicacao: 'SC',
          targetName: 'Lote Engorda',
          targetType: 'LOTE',
          status: 'REALIZADO',
          carencia_dias: 0,
          isBlocked: false,
          data_manejo: '2026-06-08',
        },
        {
          id: '2',
          titulo: 'Protocolo IATF - D0',
          produto: 'Sincrogest',
          tipo: 'PROTOCOLO',
          dose: '1 implante',
          via_aplicacao: 'INTRA',
...
vi.mock('./components/HealthProtocolsModal', () => ({
  HealthProtocolsModal: ({ isOpen, onClose, onApply }: any) =>
    isOpen ? (
        ...
        <button
          onClick={() =>
            onApply({
              protocol: {
                name: 'IATF Padrão',
                steps: [{ day: 0, product: 'Hormônio A', dose: '2ml' }],
              },
              targetType: 'LOTE',
              targetId: 'lote-1',
...
vi.mock('./components/HealthFilterModal', () => ({
  HealthFilterModal: ({ isOpen, onClose }: any) =>
    isOpen ? (
...
vi.mock('../../components/Forms/HealthForm', () => ({
  HealthForm: ({ isOpen, onClose, onSubmit }: any) =>
    isOpen ? (
