    ...
    >
      ...
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid grid-col-2">
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Building2 size={14} /> Empresa / Unidade Solicitante
            </label>
            <SearchableSelect
          ...
          <div className="tauze-field-group">
            <label className="tauze-label">
              <FileText size={14} /> Título da Solicitação
            </label>
            <input
        ...
        <div className="tauze-input-grid grid-col-2" style={{ marginTop: '16px' }}>
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Calendar size={14} /> Data Limite (Necessidade / SLA)
            </label>
            <DateInput
              className="tauze-input"
              type="date"
        ...
        <div className="tauze-input-grid grid-col-1" style={{ marginTop: '16px' }}>
          <div className="tauze-field-group">
            <label className="tauze-label">
              ...
              {(formData.priority === 'high' || formData.priority === 'urgent') && (
                <span
                  style={{ color: '#ef4444', fontSize: '10px', marginLeft: '6px', fontWeight: 800 }}
                >
                  * OBRIGATÓRIO PARA ESTA PRIORIDADE
                </span>
              )}
            </label>
            <textarea
      ...
      <section className="tauze-form-section">
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: '11px', fontWeight: 700, color: 'hsl(var(--brand))' }}>
              VALOR ESTIMADO:
            </span>
        ...
        <div className="tauze-input-grid grid-col-1">
          ...
          >
            ...
            <p style={{ fontSize: '11px', color: 'hsl(var(--text-muted))', margin: 0 }}>
              Anexe orçamentos prévios (PDF) ou fotos da máquina quebrada (JPG, PNG) para agilizar a
              aprovação.
            </p>
          </div>
        </div>
