...
export const RetentionPolicyModal: React.FC<RetentionPolicyModalProps> = ({ isOpen, onClose, onSave, initialSettings }) => {
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            <input 
              ...
              onChange={(e) => setRetentionSettings({...retentionSettings, alertDays: parseInt(e.target.value) || 0})}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            <input 
              ...
              onChange={(e) => setRetentionSettings({...retentionSettings, readOnlyDays: parseInt(e.target.value) || 0})}
              style={{ padding: '12px', borderRadius: '12px', border: '1px solid #e2e8f0', fontWeight: 700 }}
            />
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            <input 
              ...
              onChange={(e) => setRetentionSettings({...retentionSettings, pecuariaOnlyDays: parseInt(e.target.value) || 0})}
              style={{ padding: '12px', borderRadius: '12px', border: '1px solid #e2e8f0', fontWeight: 700 }}
            />
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            <input 
              ...
              onChange={(e) => setRetentionSettings({...retentionSettings, forcedPaymentDays: parseInt(e.target.value) || 0})}
              style={{ padding: '12px', borderRadius: '12px', border: '1px solid #e2e8f0', fontWeight: 700 }}
            />
          </div>
        </div>
