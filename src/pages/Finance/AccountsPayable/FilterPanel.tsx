 ...
 * Tab navigation, search, and filter controls
 */

import React from 'react';
import { Search, Filter, FileText } from 'lucide-react';
import { PayableFilterModal } from '../components/PayableFilterModal';
import type { TabType, FilterValues } from './types';
    ...
    <>
      <div className="tauze-controls-row">
        <div className="tauze-tab-group">
          ...
          <button
            className={`tauze-tab-item ${activeTab === 'PAGO' ? 'active' : ''}`}
          ...
          <div className="export-dropdown-container">
            ...
            <div id="export-menu-payable" className="export-menu">
              <button
                onClick={() => {
                  onExport('csv');
                  document.getElementById('export-menu-payable')?.classList.remove('active');
                }}
              >
                Excel (.CSV)
              </button>
