...
export const UserForm: React.FC<UserFormProps> = ({
  ...
  return (
    <SidePanel
      ...
      subtitle={
        initialData
          ? 'Atualize as permissões e dados de acesso deste usuário.'
          : 'O usuário receberá um convite por e-mail para acessar o sistema.'
      }
    ...
    >
      ...
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid grid-col-2">
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Shield size={14} /> Perfil de Acesso
            </label>
            <SearchableSelect
        ...
        <div className="tauze-field-group full-width">
          <label className="tauze-label">
            <Building2 size={14} /> Empresa / Unidade
          </label>
          <input
            type="text"
            className="tauze-input"
        ...
        <div className="tauze-field-group full-width">
          <label className="tauze-label">
            <Building2 size={14} /> Fazendas Permitidas (Acesso Restrito)
          </label>
          <div
            style={{
              display: 'grid',
          ...
          <p style={{ fontSize: '11px', color: 'hsl(var(--text-muted))', marginTop: '6px' }}>
            * Deixe desmarcado se o usuário tiver a permissão "Visão Global" no perfil (que já
      ...
      <section className="tauze-form-section">
        ...
        <div className="tauze-field-group full-width">
          <label className="tauze-label">
            <Activity size={14} /> Status do Usuário
          </label>
          <div
            style={{
              display: 'flex',
