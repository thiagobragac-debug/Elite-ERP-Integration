        ...
        <div className="tauze-sidebar-body">
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Tipo de Manejo <FlaskConical size={14} />
            </label>
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Status de Execução <Activity size={14} />
            </label>
          ...
          >
            ...
            <p style={{ fontSize: '10px', color: 'hsl(var(--text-muted))', fontWeight: 600 }}>
              Filtra animais em período de carência ativa que não podem ser destinados ao abate ou
              venda.
            </p>
          </div>
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Intervalo de Manejo <Calendar size={14} />
            </label>
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Duração da Carência (Dias) <Clock size={14} />
            </label>
            <div
