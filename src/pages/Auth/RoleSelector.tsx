      ...
      <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
        <div
          style={{
            ...
            width: 600,
            height: 600,
            background: 'radial-gradient(circle, rgba(0,184,101,0.08) 0%, transparent 65%)',
            ...
            >
              <div
                style={{
                  ...
                  height: 72,
                  borderRadius: '50%',
                  background: 'radial-gradient(circle, rgba(0,184,101,0.25) 0%, transparent 70%)',
              ...
              <div
                style={{
                  ...
                  border: '1.5px solid rgba(0,184,101,0.35)',
                  borderRadius: 16,
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  boxShadow: '0 0 28px rgba(0,184,101,0.2)',
                }}
              >
                <TauzeLogo size={28} />
              </div>
          ...
          >
            <div
              style={{
                ...
                height: 32,
                borderRadius: '50%',
                background: 'linear-gradient(135deg, #00b865, #3b82f6)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                fontSize: 13,
          ...
          >
            ...
            <div
              style={{
                ...
                borderRadius: 24,
                background:
                  'radial-gradient(circle at 50% 0%, rgba(0,184,101,0.08) 0%, transparent 70%)',
            ...
            <div
              style={{
                ...
                gap: 6,
                marginTop: 4,
                color: hoveredCard === 'erp' ? '#00b865' : 'rgba(255,255,255,0.25)',
                fontSize: 12,
                fontWeight: 800,
            ...
            >
              ...
              <span
                style={{
                  transform: hoveredCard === 'erp' ? 'translateX(4px)' : 'none',
          ...
          >
            ...
            <div
              style={{
                ...
                borderRadius: 16,
                background:
                  hoveredCard === 'saas' ? 'rgba(139,92,246,0.15)' : 'rgba(139,92,246,0.08)',
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
                <span
                  style={{ fontSize: 17, fontWeight: 900, color: '#fff', letterSpacing: '-0.02em' }}
                >
                  Painel SaaS Admin
                </span>
                <span
              ...
              >
                Tenants, planos, faturamento
                <br />e saúde global da plataforma
              </div>
            </div>
            ...
            <div
              style={{
                ...
                gap: 6,
                marginTop: 4,
                color: hoveredCard === 'saas' ? '#8b5cf6' : 'rgba(255,255,255,0.25)',
                fontSize: 12,
                fontWeight: 800,
                transition: 'color 0.3s',
                letterSpacing: '0.02em',
            ...
            >
              ...
              <span
                style={{
                  transform: hoveredCard === 'saas' ? 'translateX(4px)' : 'none',
                  transition: 'transform 0.3s',
                  display: 'inline-block',
                }}
              >
