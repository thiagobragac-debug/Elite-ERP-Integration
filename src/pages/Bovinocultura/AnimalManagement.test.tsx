...
// Mocking Modals
vi.mock('../../components/Forms/AnimalForm', () => ({
  AnimalForm: () => <div data-testid="animal-form-mock" />,
}));
vi.mock('./components/QuickManejoModal', () => ({
  QuickManejoModal: () => <div data-testid="quick-manejo-mock" />,
}));
vi.mock('../../components/Modals/RomaneioEmbarqueModal', () => ({
  RomaneioEmbarqueModal: () => <div data-testid="romaneio-mock" />,
}));
...
describe('AnimalManagement', () => {
  ...
  it('renders title and page actions', () => {
    renderComponent();
    expect(
      screen.getByText('Inventário individualizado e controle de ativos biológicos em tempo real.')
    ).toBeInTheDocument();
