...
export const PriceAlertModal: React.FC<PriceAlertModalProps> = ({
  isOpen,
  onClose,
  defaultIndicator = 'boi_gordo_cepea',
  onSuccess,
}) => {
          ...
          >
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: '11px', color: '#64748b', lineHeight: '1.4' }}>
                O robô do Copilot monitora as cotações oficiais todos os dias. Se este alvo for
                atingido, você receberá um alerta no Painel de Vendas.
              </p>
            </div>
