        ...
        <div className="tauze-sidebar-body">
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Risco de Churn <AlertTriangle size={14} />
            </label>
            <button
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Rating de Crédito <Star size={14} />
            </label>
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Exposição Financeira (LTV) <DollarSign size={14} />
            </label>
            <div
            ...
            >
              ...
              >
                <span style={{ fontSize: '22px', fontWeight: 900, color: '#10b981' }}>
                  {filters.maxLtv.toLocaleString('pt-BR')}
                </span>
                <span
