  ...
  return {
    ...
    useQuery: vi.fn((options: any) => {
      ...
      if (key === 'audits') {
        return {
          data: [
            { id: '1', titulo: 'Auditoria Mensal', responsavel: 'Admin', categoria: 'Estoque Geral', status: 'completed', accuracy: 99, data: '2026-06-08' },
            { id: '2', titulo: 'Inventário Parcial', responsavel: 'Admin', categoria: 'Sementes', status: 'in_progress', accuracy: 88, data: '2026-06-07' }
          ],
          isLoading: false
        };
      }
