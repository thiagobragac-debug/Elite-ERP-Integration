...
export const ReceivableFilterModal: React.FC<ReceivableFilterModalProps> = ({
  isOpen,
  onClose,
  filters,
  setFilters
      ...
      >
        <div className="tauze-sidebar-header">
          <div className="header-content" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              ...
              <p>Gestão de faturamento e aging.</p>
            </div>
          </div>
          <button 
        ...
        <div className="tauze-sidebar-body">
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">Status do Recebível <Target size={14} /></label>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '8px' }}>
              {[
                { id: 'all', label: 'Todos os Títulos', color: 'hsl(var(--text-muted))' },
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">Valor da Fatura (R$) <DollarSign size={14} /></label>
            <div className="integrity-slider-container" style={{ padding: '20px', background: 'hsl(var(--bg-main))', borderRadius: '16px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '16px' }}>
                <span style={{ fontSize: '22px', fontWeight: 900, color: '#10b981' }}>{filters.maxAmount.toLocaleString('pt-BR')}</span>
