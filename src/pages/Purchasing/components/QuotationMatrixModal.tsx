...
export const QuotationMatrixModal: React.FC<QuotationMatrixModalProps> = ({
  ...
  const bids = rawBids.map((b, index) => {
    ...
    const isWinner = !!(
      b.isWinner ||
      b.vencedor ||
      (quotation.status === 'closed' && (b.isWinner || b.vencedor))
    );
  ...
  return (
    ...
    >
      ...
      >
        {loading ? (
          <LoadingSkeleton variant="table" rows={3} columns={4} fullScreen={false} />
        ) : bids.length === 0 ? (
          <div
            style={{
              padding: '48px',
          ...
          >
            ...
            <p style={{ fontSize: '12px', color: 'hsl(var(--text-muted))' }}>
              Este mapa de cotação ainda não possui propostas de fornecedores cadastradas.
            </p>
          </div>
        ) : (
          <>
                    ...
                    return (
                      <motion.div
                        ...
                        style={{
                          ...
                          alignItems: 'center',
                          borderBottom:
                            index === bids.length - 1 ? 'none' : '1px solid hsl(var(--border))',
                      ...
                      >
                        ...
                        <div style={{ textAlign: 'center' }}>
                          ...
                          >
                            {bid.parsedPrice.toLocaleString('pt-BR', {
                              style: 'currency',
                              currency: 'BRL',
                            })}
                          </span>
