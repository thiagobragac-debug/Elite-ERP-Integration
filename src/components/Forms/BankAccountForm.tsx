    ...
    >
      <section className="tauze-form-section">
        ...
        <div className="tauze-field-group full-width">
          <label className="tauze-label">
            <Building2 size={14} /> Vinculação (CNPJ / Empresa)
          </label>
          <SearchableSelect
        ...
        <div className="tauze-input-grid grid-col-2">
          {formData.tipo !== 'CAIXA' && (
            <>
              <div className="tauze-field-group">
                <label className="tauze-label">
                  <Building2 size={14} /> Banco / Instituição
                </label>
                <input
                  type="text"
          ...
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Info size={14} /> Descrição / Apelido
            </label>
            <input
              type="text"
              className="tauze-input"
        ...
        <div className="tauze-field-group full-width">
          <label className="tauze-label">
            <Activity size={14} /> Tipo de Conta
          </label>
          <div className="tauze-form-radio-group" style={{ gridTemplateColumns: 'repeat(5, 1fr)' }}>
            ...
            <div
              ...
              style={
                formData.tipo === 'CUSTEIO'
                  ? { background: '#f0fdf4', borderColor: '#166534', color: '#166534' }
                  : {}
              }
            ...
            <div
              ...
              onClick={() =>
                setFormData({ ...formData, tipo: 'CAIXA', banco: '', agencia: '', conta: '' })
              }
            >
              <Hash size={16} />
              <span>Caixa</span>
      ...
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid grid-col-2">
          <div className="tauze-field-group">
            <label className="tauze-label">
              <CreditCard size={14} /> Saldo Inicial (R$)
            </label>
            <input
              type="number"
              step="0.01"
          ...
          {formData.tipo !== 'CAIXA' && formData.tipo !== 'CUSTEIO' && (
            <div className="tauze-field-group">
              <label className="tauze-label">
                <ShieldCheck size={14} /> Limite de Crédito (R$)
              </label>
              <input
                type="number"
                step="0.01"
          ...
          {formData.tipo === 'INVESTIMENTO' && (
            <div className="tauze-field-group full-width">
              <label className="tauze-label">
                <TrendingUp size={14} /> Benchmark Rendimento
              </label>
              <select
                className="tauze-input"
          ...
          {formData.tipo === 'CUSTEIO' && (
            <div className="tauze-field-group full-width">
              <label className="tauze-label" style={{ color: '#166534' }}>
                <TrendingUp size={14} /> Taxa de Juros a.a. (%)
              </label>
              <input
                type="number"
                step="0.01"
