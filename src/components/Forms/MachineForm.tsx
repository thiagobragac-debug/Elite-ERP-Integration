            ...
            {currentStep < 3 ? (
              <button
                ...
                onClick={() => {
                  if (
                    currentStep === 1 &&
                    (!formData.nome.trim() || !formData.marca.trim() || !formData.modelo.trim())
                  ) {
                    return;
                  }
                  setTimeout(() => {
              ...
              <button key="submit-btn" type="submit" className="primary-btn" disabled={loading}>
          ...
          <React.Fragment key={s.number}>
            ...
            >
              ...
              <span
                style={{
                  fontSize: '12px',
                  fontWeight: currentStep === s.number ? 800 : 600,
                  color: currentStep === s.number ? 'hsl(var(--text-main))' : '#94a3b8',
                }}
              >
                {s.label}
              </span>
            ...
            {idx < steps.length - 1 && (
              <div
                style={{
                  flex: 1,
                  height: '2px',
                  background: currentStep > s.number ? '#10b981' : '#e2e8f0',
                  margin: '0 12px',
                }}
              />
            )}
        ...
        >
          <section className="tauze-form-section" style={{ margin: 0 }}>
            ...
            <div className="tauze-input-grid grid-col-3" style={{ alignItems: 'flex-end' }}>
              ...
              <div className="tauze-field-group">
                <label className="tauze-label">
                  <Gauge size={14} /> Unidade de Medida Padrão
                </label>
                <div
                  className="tauze-form-radio-group"
                  style={{ gridTemplateColumns: 'repeat(2, 1fr)', height: '48px' }}
                >
                  {['horas', 'km'].map((t) => (
                    <div
                      key={t}
            ...
            <div
              ...
              style={{ marginTop: '16px', alignItems: 'flex-end' }}
            >
              <div className="tauze-field-group">
                <label className="tauze-label">
                  <Tag size={14} /> Marca
          ...
          <section className="tauze-form-section" style={{ margin: 0 }}>
            ...
            <div className="tauze-input-grid grid-col-3">
              ...
              {formData.unidade_medida === 'horas' ? (
                <div className="tauze-field-group">
                  <label className="tauze-label">
                    <Clock size={14} /> Horímetro Inicial (h)
                  </label>
                  <input
                    className="tauze-input"
                    type="number"
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, horimetro_inicial: e.target.value })
                    }
                  />
                </div>
              ) : (
                <div className="tauze-field-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, quilometragem_inicial: e.target.value })
                    }
                  />
                </div>
              )}
