...
export const ProfileForm: React.FC<ProfileFormProps> = ({
  ...
  const applyTemplate = (templateId: string) => {
    ...
    setFormData((prev) => ({
      ...prev,
      permissoes: newPerms,
      is_global: templateId === 'admin' || templateId === 'cfo',
    }));
  };
  ...
  const toggleFullRow = (moduleId: string, actions: string[]) => {
    ...
    if (current.length === actions.length) {
      ...
      setFormData({
        ...formData,
        permissoes: { ...formData.permissoes, [moduleId]: [...actions] },
      });
    }
  };
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          >
            ...
            <div
              ...
              style={{ flexDirection: 'column', margin: 0, gap: '8px' }}
            >
              <div
              ...
              >
                ...
                <div style={{ textAlign: 'left' }}>
                  <div style={{ fontWeight: 800, fontSize: '12px' }}>
                    Holding (Todas as Fazendas)
                  </div>
                  <div style={{ fontSize: '10px', color: 'var(--text-muted)' }}>
                    Vê dados de todos os CNPJs.
                  </div>
                </div>
              </div>
              <div
          ...
          >
            <div>
              ...
              <div style={{ fontSize: '11px', color: 'hsl(var(--text-muted))' }}>
                Preencha os papéis manualmente ou use um atalho.
              </div>
            </div>
                      ...
                      <td style={{ padding: '12px' }}>
                        <button
                          ...
                          style={{
                            ...
                            border: 'none',
                            cursor: 'pointer',
                            color: isAll ? 'hsl(var(--brand))' : 'hsl(var(--text-muted))',
                            padding: '4px',
                          }}
                        >
                          <Copy size={14} />
