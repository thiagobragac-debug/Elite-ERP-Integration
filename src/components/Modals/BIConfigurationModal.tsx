  ...
  return (
    ...
    >
      ...
      >
                  ...
                  {catMetrics.map((metric) => (
                    <button
                      ...
                      style={{
                        ...
                        padding: '10px',
                        borderRadius: '12px',
                        border: `1.5px solid ${selectedMetrics.includes(metric.name) ? '#27a376' : 'hsl(var(--border))'}`,
                        background: selectedMetrics.includes(metric.name)
                          ? 'rgba(39, 163, 118, 0.05)'
                          : 'white',
                    ...
                    >
                      <div
                        style={{
                          ...
                          color: selectedMetrics.includes(metric.name)
                            ? '#27a376'
                            : 'hsl(var(--text-muted))',
                        }}
                      >
                      ...
                      {selectedMetrics.includes(metric.name) && (
                        <CheckCircle2 size={16} style={{ color: '#27a376' }} />
                      )}
                    </button>
                  ))}
                </div>
        ...
        <div
          style={{ background: 'hsl(var(--bg-main)/0.3)', borderRadius: '24px', padding: '24px' }}
        >
          <div
            style={{
              display: 'flex',
          ...
          >
            <h3 style={{ fontSize: '14px', fontWeight: 900 }}>
              Visualização do Canvas (Drag & Drop)
            </h3>
            <span
              style={{
                fontSize: '9px',
            ...
            >
              {selectedMetrics.length} MÉTRICAS ATIVAS
            </span>
          </div>
          ...
          {isSaving ? (
                ...
                >
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <GripHorizontal
                        size={14}
                        style={{ color: 'hsl(var(--text-muted))', cursor: 'grab' }}
                      />
                      <span
                        style={{
                          fontSize: '10px',
            ...
            >
              ...
              <p style={{ fontSize: '14px', fontWeight: 600 }}>
                Selecione métricas ao lado para começar
                <br />a montar seu BI customizado.
              </p>
            </div>
          )}
        </div>
