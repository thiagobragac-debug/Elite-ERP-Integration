...
vi.mock('../../components/Forms/LotForm', () => ({
  LotForm: () => <div data-testid="lot-form-mock" />,
}));
vi.mock('../../components/Forms/RelocateForm', () => ({
  RelocateForm: () => <div data-testid="relocate-form-mock" />,
}));
vi.mock('../../components/Forms/AssignAnimalForm', () => ({
  AssignAnimalForm: () => <div data-testid="assign-animal-form-mock" />,
}));
vi.mock('../../components/Modals/ProcessarLoteModal', () => ({
  ProcessarLoteModal: ({ title }: any) => <div>{title || 'Processamento de Lote Pendente'}</div>,
}));
