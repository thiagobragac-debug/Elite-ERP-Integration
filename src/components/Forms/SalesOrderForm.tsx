    ...
    >
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid grid-col-3">
          ...
          <div className="tauze-field-group">
            <label className="tauze-label">
              <User size={14} /> Parceiro / Comprador
            </label>
            <SearchableSelect
        ...
        <div className="tauze-input-grid grid-col-3" style={{ marginTop: '16px' }}>
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Hash size={14} /> Número do Pedido (PV)
            </label>
            <input
      ...
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid" style={{ gridTemplateColumns: 'repeat(5, 1fr)' }}>
          ...
          <div className="tauze-field-group">
            <label className="tauze-label">
              <FileText size={14} /> GTA (Guia de Trânsito)
            </label>
            <input
              className="tauze-input"
              type="text"
          ...
          <div className="tauze-field-group">
            <label className="tauze-label" style={{ color: 'hsl(var(--brand))' }}>
              <DollarSign size={14} /> Valor da Comissão (R$)
            </label>
            <input
              className="tauze-input"
              type="text"
          ...
          <div style={{ width: '300px' }}>
            ...
            <div className="tauze-field-group">
              <input
                className="tauze-input"
                type="text"
                value={formData.totalValue.toLocaleString('pt-BR', {
                  style: 'currency',
                  currency: 'BRL',
                })}
                readOnly
      ...
      <section className="tauze-form-section">
        ...
        >
          ...
          <div className="tauze-field-group">
            <label className="tauze-label">
              <CreditCard size={14} /> Meio de Recebimento
            </label>
            <SearchableSelect
              ...
              <div
                style={{
                  ...
                  color:
                    ...
                    parseFloat(formData.totalValue.toString()).toFixed(2)
                      ? 'green'
                      : 'red',
                }}
              >
