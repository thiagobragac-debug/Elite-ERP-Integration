    ...
    >
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid grid-col-2" style={{ marginTop: '16px' }}>
          <div className="tauze-field-group">
            <label className="tauze-label"><FileText size={14} /> Plano de Assinatura *</label>
            <SearchableSelect 
      ...
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid grid-col-2">
          <div className="tauze-field-group">
            <label className="tauze-label"><DollarSign size={14} /> Valor Base da Fatura (R$) *</label>
            <input 
          ...
          <div className="tauze-field-group">
            <label className="tauze-label"><TrendingDown size={14} /> Desconto Comercial / Pró-rata (R$)</label>
            <input 
              className="tauze-input"
              type="number" 
              step="0.01"
        ...
        <div style={{ 
          ...
          <div>
            <div style={{ fontSize: '11px', color: 'hsl(var(--text-muted))', fontWeight: 800, textTransform: 'uppercase' }}>Valor Líquido da Fatura</div>
            <div style={{ fontSize: '10px', color: 'hsl(var(--text-muted))' }}>Base (R$ {baseAmount.toFixed(2)}) - Desconto (R$ {discountAmount.toFixed(2)})</div>
          </div>
      ...
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid grid-col-2">
          ...
          <div className="tauze-field-group">
            <label className="tauze-label"><CheckCircle2 size={14} /> Status Financeiro</label>
            <SearchableSelect 
        ...
        <div className="tauze-input-grid grid-col-1" style={{ marginTop: '16px' }}>
          <div className="tauze-field-group">
            <label className="tauze-label"><LinkIcon size={14} /> Link do Gateway (Opcional)</label>
            <input 
              className="tauze-input"
              type="url" 
        ...
        >
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontWeight: 800, fontSize: '13px', color: formData.auto_send_email ? 'hsl(var(--brand))' : 'hsl(var(--text-main))' }}>
              <Mail size={16} /> Régua Automática: Enviar Fatura por E-mail
            </div>
            <div style={{ fontSize: '11px', color: 'hsl(var(--text-muted))', marginTop: '2px' }}>
              Ao salvar, o Inquilino será notificado com o espelho da fatura, chaves de pagamento e PDF.
            </div>
          </div>
        </div>
