    ...
    >
      ...
      >
        ...
        <div className="tauze-sidebar-body">
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Diagnóstico de Gestação <Thermometer size={14} />
            </label>
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Escore Corporal (ECC) <TrendingUp size={14} />
            </label>
            <div
            ...
            >
              ...
              >
                <span style={{ fontSize: '22px', fontWeight: 900, color: '#ec4899' }}>
                  {filters.minECC} a {filters.maxECC}
                </span>
                <span
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Período do Evento <Calendar size={14} />
            </label>
