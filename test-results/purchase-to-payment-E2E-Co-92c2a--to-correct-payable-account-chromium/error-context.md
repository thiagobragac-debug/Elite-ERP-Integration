...
- Name: purchase-to-payment.spec.ts >> E2E: Complete Purchase-to-Payment Flow >> should validate purchase order links to correct payable account
- Location: tests\e2e\purchase-to-payment.spec.ts:532:3
