        ...
        <div className="tauze-sidebar-body">
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Status Operacional <Clock size={14} />
            </label>
            <div
              style={{
                display: 'flex',
          ...
          <div className="tauze-filter-section">
            ...
            >
              ...
              >
                <span style={{ fontSize: '28px', fontWeight: 900, color: '#8b5cf6' }}>
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Finalidade Produtiva <TrendingUp size={14} />
            </label>
            <div className="tauze-tag-cloud">
              {finalidades.map((fin) => (
                <button
                  ...
                  style={{
                    borderColor: filters.finalidades?.includes(fin)
                      ? '#8b5cf6'
                      : 'hsl(var(--border))',
                    background: filters.finalidades?.includes(fin)
                      ? '#8b5cf6'
                      : 'hsl(var(--bg-card))',
              ...
              {['all', 'Alta', 'Média', 'Baixa'].map((u) => (
                <button
                  ...
                  style={{
                    ...
                    fontSize: '10px',
                    fontWeight: 800,
                    color: filters.uniformityLevel === u ? '#8b5cf6' : 'hsl(var(--text-muted))',
                    background:
                      filters.uniformityLevel === u ? 'hsl(var(--bg-card))' : 'transparent',
                    borderRadius: '10px',
                    border: 'none',
                    cursor: 'pointer',
                  }}
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Data de Formação <Calendar size={14} />
            </label>
            <div
