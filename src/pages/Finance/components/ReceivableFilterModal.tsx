      ...
      >
        ...
        <div className="elite-sidebar-body">
          <div className="elite-filter-section">
            <label className="elite-filter-label">Status do Recebível <Target size={14} /></label>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '8px' }}>
              {[
                { id: 'all', label: 'Todos os Títulos', color: '#64748b' },
          ...
          <div className="elite-filter-section">
            <label className="elite-filter-label">Valor da Fatura (R$) <DollarSign size={14} /></label>
