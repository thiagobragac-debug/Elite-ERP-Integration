  ...
  const generateInstallments = () => {
    ...
    for (let i = 1; i <= count; i++) {
      ...
      newList.push({
        ...
        value:
          i === count
            ? parseFloat((totalLiquido - valuePerInstallment * (count - 1)).toFixed(2))
            : valuePerInstallment,
      });
    }
    ...
    >
      <section className="tauze-form-section">
        ...
        >
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Building2 size={14} /> Empresa / Unidade Compradora
            </label>
            <SearchableSelect
          ...
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Truck size={14} /> Previsão de Entrega
            </label>
            <DateInput
              className="tauze-input"
              type="date"
          ...
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Hash size={14} /> Número do Pedido (OC)
            </label>
            <input
              className="tauze-input"
              type="text"
        ...
        <div className="tauze-input-grid grid-col-3" style={{ marginBottom: '16px' }}>
          ...
          <div className="tauze-field-group">
            <label className="tauze-label">
              <ClipboardList size={14} /> Origem (Cotação)
            </label>
            <SearchableSelect
      ...
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid grid-col-1">
          <InsumoEntryTable items={items} onChange={setItems} companyId={formData.company_id} />
        </div>
          ...
          >
            ...
            >
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
                ...
                <div>
                  <label className="tauze-label" style={{ fontSize: '11px' }}>
                    <Truck size={12} /> Valor do Frete (R$)
                  </label>
                  <input
                    className="tauze-input"
                    type="number"
                ...
                <div>
                  <label className="tauze-label" style={{ fontSize: '11px' }}>
                    <TrendingDown size={12} /> Desconto Global (R$)
                  </label>
                  <input
                    className="tauze-input"
                    type="number"
            ...
            <div
              style={{
                ...
                padding: '24px',
                borderRadius: '12px',
                border: '2px dashed hsl(var(--brand)/0.3)',
              }}
            >
              <span
                style={{
          ...
          style={{
            gridTemplateColumns:
              formData.payment_condition === 'prazo'
                ? '1.5fr 1.5fr 1fr 2fr 1.2fr'
                : '1fr 1fr 1.5fr 1.2fr',
          }}
        >
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Banknote size={14} /> Condição Comercial
            </label>
            <SearchableSelect
          ...
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Wallet size={14} /> Conta Bancária / Caixa de Origem
            </label>
            <SearchableSelect
      ...
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid grid-col-2">
          <div className="tauze-field-group">
            <label className="tauze-label">
              <MapPin size={14} /> Instruções e Local de Entrega
            </label>
            <textarea
