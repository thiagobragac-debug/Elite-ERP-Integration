...
- Name: purchase-to-payment.spec.ts >> Purchase-to-Payment Flow - Edge Cases >> should navigate between pending and paid tabs
- Location: tests\e2e\purchase-to-payment.spec.ts:650:3
