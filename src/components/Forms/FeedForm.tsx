...
export const FeedForm: React.FC<FeedFormProps> = ({ isOpen, onClose, onSubmit, actionId }) => {
  ...
  const isInsumosDone =
    cartItems.length > 0 && cartItems.every((i: any) => !!i.produto_id && !!i.quantidade);
          ...
          >
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: '13px', color: 'hsl(var(--text-muted))' }}>
                ...
                {activeEtapa === 'insumos' &&
                  'Informe as quantidades fornecidas e os depósitos de onde sairão os insumos.'}
              </p>
            </div>
            ...
            {activeEtapa === 'dados' && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                <div className="tauze-input-grid grid-col-2">
                  ...
                  <div className="tauze-field-group">
                    <label className="tauze-label">
                      <Activity size={14} /> Dieta / Formulação
                    </label>
                    <SearchableSelect
                  ...
                  <div className="tauze-field-group" style={{ gridColumn: 'span 2' }}>
                    <label className="tauze-label">
                      <Calendar size={14} /> Data do Trato
                    </label>
                    <DateInput
