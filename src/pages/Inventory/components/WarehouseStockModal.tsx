  ...
  const historyColumns = [
    ...
    },
    {
      ...
      accessor: (item: any) => {
        ...
        return (
          <span
            style={{ fontWeight: 800, color: isEntry ? '#10b981' : '#ef4444', fontSize: '13px' }}
          >
            {isEntry ? '+' : '-'}
      ...
      >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <h3 style={{ margin: 0, fontSize: '18px', fontWeight: 800 }}>
                {warehouseName || 'Detalhes do Depósito'}
              </h3>
              <p style={{ margin: '2px 0 0', fontSize: '12px', color: '#94a3b8', fontWeight: 500 }}>
                Posição de Estoque & Movimentações
              </p>
            </div>
          </div>
        ...
        >
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <div
              className="tauze-search-wrapper"
              style={{ width: '280px', margin: 0, background: 'hsl(var(--bg-main))' }}
            >
            ...
            {!loading && activeTab === 'stock' && filteredStock.length === 0 && (
              <div style={{ padding: '40px', textAlign: 'center', color: '#94a3b8' }}>
                <p style={{ fontWeight: 600, fontSize: '13px' }}>
                  Nenhum insumo encontrado neste depósito.
                </p>
              </div>
            )}
