    ...
    >
      ...
      >
        ...
        <div className="tauze-sidebar-body">
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Integridade de Dados <Shield size={14} />
            </label>
            <div
            ...
            >
              ...
              >
                ...
                <span
                  style={{ fontSize: '11px', fontWeight: 700, color: 'hsl(var(--text-muted))' }}
                >
                  Acuracidade Mínima
                </span>
              </div>
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Carga do Motor (Latency) <Zap size={14} />
            </label>
            <div
              style={{
                display: 'flex',
            ...
            >
              <button
                style={{
                  ...
                  fontSize: '11px',
                  fontWeight: 800,
                  color: filters.complexity === 'all' ? '#10b981' : 'hsl(var(--text-muted))',
                  background: filters.complexity === 'all' ? 'hsl(var(--bg-card))' : 'transparent',
                  borderRadius: '10px',
                  border: 'none',
                  cursor: 'pointer',
                  boxShadow: filters.complexity === 'all' ? '0 2px 8px rgba(0,0,0,0.05)' : 'none',
                }}
              ...
              {complexities.map((c) => (
                <button
                  ...
                  style={{
                    ...
                    fontSize: '11px',
                    fontWeight: 800,
                    color: filters.complexity === c ? '#10b981' : 'hsl(var(--text-muted))',
                    background: filters.complexity === c ? 'hsl(var(--bg-card))' : 'transparent',
                    borderRadius: '10px',
                    border: 'none',
                    cursor: 'pointer',
                    boxShadow: filters.complexity === c ? '0 2px 8px rgba(0,0,0,0.05)' : 'none',
                  }}
