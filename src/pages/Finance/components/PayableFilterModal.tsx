...
interface PayableFilterModalProps {
  ...
  setFilters: (filters: PayableFilters) => void;
}
        ...
        <div className="tauze-sidebar-body">
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Status da Conta <Activity size={14} />
            </label>
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Valor do Título (R$) <DollarSign size={14} />
            </label>
            <div
            ...
            >
              ...
              >
                <span style={{ fontSize: '22px', fontWeight: 900, color: '#6366f1' }}>
