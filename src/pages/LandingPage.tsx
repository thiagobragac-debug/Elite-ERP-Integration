...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className={`elite-landing ${theme}`}>
      {/* --- Premium Navigation --- */}
      <nav className={`noir-nav ${scrolled ? 'scrolled' : ''}`}>
        <div className="nav-container">
          <div className="logo-group">
            <div className="logo-icon">
              <Zap size={18} fill="#10b981" color="#10b981" />
            </div>
        ...
        <div className="container hero-grid">
          ...
          >
            ...
            <p className="hero-description">
              ...
              Inteligência artificial, telemetria em tempo real e auditoria absoluta para produtores de elite.
            </p>
      ...
      <section className="features-mosaic-section" id="features">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-subtitle">Toda a potência do Elite ERP consolidada em uma experiência visual superior.</p>
          </div>
      ...
      <footer className="noir-footer">
        ...
        <div className="footer-bottom">
          <div className="container">
            <p>&copy; 2026 Elite Intelligence. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
