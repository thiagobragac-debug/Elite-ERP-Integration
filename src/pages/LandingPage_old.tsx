  ...
  return (
    <div className="landing-diamond-v8">
          ...
          >
            <div className="showcase-container-v20">
              ...
              <motion.div 
                ...
                className="cattle-v20"
              >
                <img src="/pecuaria-v10.png" alt="Pecuária 5.0" />
                
                {/* Minimalist HUD */}
                <div className="hud-v11">
                  <div className="hud-line-v11 l1">
                    <div className="dot"></div>
                    <div className="info"><span>PESO:</span> 842KG</div>
                  </div>
                  <div className="hud-line-v11 l2">
                    <div className="dot"></div>
                    <div className="info"><span>GMD:</span> 0.842</div>
                  </div>
                  <div className="hud-line-v11 l3">
                    <div className="dot"></div>
                    <div className="info"><span>STATUS:</span> ATIVO</div>
                  </div>
                </div>
              </motion.div>
            </div>
      ...
      <style>{`
        ...
        .dashboard-v20 img { width: 100%; height: 100%; object-fit: cover; display: block; }
        .dashboard-overlay-v11 { position: absolute; inset: 0; background: rgba(255,255,255,0.01); pointer-events: none; }
        ...
        .ai-status-dot { width: 6px; height: 6px; background: #10b981; border-radius: 50%; box-shadow: 0 0 10px #10b981; }
        ...
        .hud-v11 { position: absolute; inset: 0; pointer-events: none; }
        .hud-line-v11 { position: absolute; display: flex; align-items: center; gap: 10px; }
        .hud-line-v11 .dot { width: 6px; height: 6px; background: #10b981; border-radius: 50%; box-shadow: 0 0 15px #10b981; }
        .hud-line-v11 .info { 
        ...
        .hud-line-v11 .info span { color: #10b981; margin-right: 4px; }
