...
export const FormPageLayout: React.FC<FormPageLayoutProps> = ({
  ...
  return (
    <div className="form-page-container" style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: '24px', gap: '24px' }}>
      <style>{`
        .form-page-header {
          display: flex;
        ...
        <div className="form-page-header">
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              ...
              <p style={{ margin: '4px 0 0', fontSize: '14px', color: 'hsl(var(--text-muted))', fontWeight: 500 }}>{subtitle}</p>
            </div>
          </div>
          <div style={{ display: 'flex', gap: '16px' }}>
            ...
            <button type="button" className="primary-btn" onClick={onSubmit} disabled={loading} style={{ boxShadow: '0 8px 20px hsl(var(--brand) / 0.2)' }}>
              <Save size={18} />
