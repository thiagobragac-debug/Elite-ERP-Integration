...
- Name: purchase-to-payment.spec.ts >> Purchase-to-Payment Flow - Edge Cases >> should validate required fields in purchase order form
- Location: tests\e2e\purchase-to-payment.spec.ts:566:3
