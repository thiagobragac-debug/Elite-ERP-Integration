  ...
  const generateInstallments = () => {
    ...
    for (let i = 1; i <= count; i++) {
      ...
      newList.push({
        ...
        value:
          i === count
            ? parseFloat((total - valuePerInstallment * (count - 1)).toFixed(2))
            : valuePerInstallment,
      });
    }
    ...
    >
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid grid-col-3">
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Building2 size={14} /> Empresa / Unidade Produtiva
            </label>
            <SearchableSelect
          ...
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Settings size={14} /> Tipo de Operação
            </label>
            <SearchableSelect
              value={formData.type}
          ...
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Hash size={14} /> Número do Contrato
            </label>
            <input
        ...
        <div className="tauze-input-grid grid-col-3" style={{ marginTop: '16px' }}>
          <div className="tauze-field-group" style={{ gridColumn: 'span 2' }}>
            <label className="tauze-label">
              <Users size={14} /> Parceiro Comercial
            </label>
      ...
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid grid-col-4">
          <div className="tauze-field-group" style={{ gridColumn: 'span 2' }}>
            <label className="tauze-label">
              <Package size={14} /> Produto / Ativo-Objeto
            </label>
            <SearchableSelect
          ...
          <div className="tauze-field-group">
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, product_quantity: parseFloat(e.target.value) || 0 })
              }
            />
          </div>
          <div className="tauze-field-group">
        ...
        <div
          className="tauze-input-grid grid-col-3"
          style={{
            marginTop: '16px',
        ...
        >
          <div className="tauze-field-group">
            <label className="tauze-label">
              <BarChart2 size={14} /> Mecanismo de Preço
            </label>
            <SearchableSelect
          ...
          {formData.price_mechanism === 'fixed' ? (
            <>
              <div className="tauze-field-group">
                <label className="tauze-label">
                  <DollarSign size={14} /> Preço Unitário ({formData.currency})
                </label>
                <input
                  className="tauze-input"
                  type="number"
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, product_price: parseFloat(e.target.value) || 0 })
                  }
                />
              </div>
              <div className="tauze-field-group">
                <label className="tauze-label" style={{ color: 'hsl(var(--brand))' }}>
                  <DollarSign size={14} /> Valor Total do Contrato
                </label>
                <input
                  className="tauze-input"
                  type="text"
      ...
      <section className="tauze-form-section">
        ...
        <div className="tauze-input-grid grid-col-2">
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Calendar size={14} /> Data de Assinatura / Início
            </label>
            <DateInput
              className="tauze-input"
              type="date"
          ...
          <div className="tauze-field-group">
            <label className="tauze-label">
              <Calendar size={14} /> Data Limite de Entrega / Vencimento
            </label>
            <DateInput
              className="tauze-input"
              type="date"
        ...
        <div className="tauze-input-grid grid-col-1" style={{ marginTop: '16px' }}>
          <div className="tauze-field-group">
            <label className="tauze-label">
              <FileText size={14} /> Cláusulas Principais / Multas e Garantias
            </label>
            <textarea
        ...
        {formData.price_mechanism === 'fixed' ? (
          <>
            <div className="tauze-input-grid grid-col-2">
              <div className="tauze-field-group">
                <label className="tauze-label">
                  <Banknote size={14} /> Condição de Liquidação
                </label>
                <SearchableSelect
              ...
              <div className="tauze-field-group">
                <label className="tauze-label">
                  <CreditCard size={14} /> Meio Principal
                </label>
                <SearchableSelect
              ...
              {formData.payment_condition === 'prazo' && (
                <div className="tauze-field-group">
                  <label className="tauze-label">
                    <Hash size={14} /> N° de Parcelas / Entregas
                  </label>
                  <input
                    className="tauze-input"
                    type="number"
              ...
              <div
                ...
                style={{ gridColumn: formData.payment_condition === 'prazo' ? 'span 1' : 'span 2' }}
              >
                <label className="tauze-label">
                  <Wallet size={14} /> Conta Vinculada
                </label>
                <SearchableSelect
              ...
              <div className="tauze-field-group">
                <label
                  style={{
                    ...
                    padding: '16px',
                    borderRadius: '12px',
                    border: '1px dashed hsl(var(--success)/0.3)',
                    cursor: 'pointer',
                  }}
                >
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, generate_financial: e.target.checked })
                    }
                    style={{
                      width: '20px',
                      height: '20px',
                  ...
                  <div
                    style={{
                      ...
                      color:
                        ...
                        parseFloat(formData.total_value.toString()).toFixed(2)
                          ? 'green'
                          : 'red',
                    }}
                  >
                    Soma das Previsões: {formData.currency}{' '}
                    {installmentsList
                    ...
                    {installmentsList.reduce((acc, i) => acc + i.value, 0).toFixed(2) !==
                      ...
                      <span style={{ display: 'block', fontSize: '10px', marginTop: '4px' }}>
                        (Divergente do total do contrato)
                      </span>
                    )}
                  </div>
                </div>
          ...
          >
            ...
            <div style={{ fontSize: '13px', fontWeight: '700', color: 'hsl(var(--text-primary))' }}>
              Cronograma Financeiro em Aberto
            </div>
            <div
              style={{
                fontSize: '12px',
            ...
            >
              Como este contrato possui precificação "A Fixar", as parcelas financeiras só poderão
              ser geradas após a fixação dos preços de tela no momento do embarque.
            </div>
          </div>
        )}
      </section>
