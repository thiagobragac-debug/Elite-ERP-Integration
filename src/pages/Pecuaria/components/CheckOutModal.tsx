...
export const CheckOutModal: React.FC<CheckOutModalProps> = ({
  ...
  const getDOF = (pen: any) =>
    Math.floor((Date.now() - new Date(pen.data_inicio).getTime()) / 86400000);
  ...
  const stats = selectedPen
    ? [
        ...
        },
        {
          Icon: TrendingUp,
          label: 'GMD',
          value: selectedPen.gmd_atual ? `${selectedPen.gmd_atual} kg/d` : '—',
        },
        {
          Icon: Calendar,
          label: 'Entrada',
          value: new Date(selectedPen.data_inicio).toLocaleDateString('pt-BR'),
        },
        {
          Icon: DollarSign,
          label: 'CPD',
          value: selectedPen.custo_por_dia
            ? `R$ ${Number(selectedPen.custo_por_dia).toFixed(2)}`
            : '—',
        },
      ]
    : [];
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ fontSize: 17, fontWeight: 900, marginTop: 2 }}>
                        {selectedPen.nome_curral}
                      </div>
                      <div style={{ fontSize: 11, opacity: 0.8, marginTop: 1 }}>
                        Lote: {selectedPen.lotes?.nome || '—'}
                      </div>
                    </div>
                    {/* Stats grid */}
                    <div
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: 13, fontWeight: 800 }}>
                    {selectedPen?.nome_curral} • {selectedPen?.lotes?.nome}
                  </div>
                </div>
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 18 }}>
                ...
                >
                  ...
                  <p>
                    Ao confirmar, o lote será arquivado e o curral ficará disponível para um novo
                    ciclo.
                  </p>
                </div>
              </div>
              ...
              {fechamentoStats && fechamentoStats.pesoSaida > 0 && (
                <div
                  style={{
                    ...
                    borderRadius: '14px',
                    background:
                      fechamentoStats.isWeightValid && fechamentoStats.isDateValid
                        ? 'hsl(var(--brand) / 0.08)'
                        : 'hsl(0 84% 60% / 0.08)',
                  ...
                  {!fechamentoStats.isDateValid || !fechamentoStats.isWeightValid ? (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                      ...
                      {!fechamentoStats.isWeightValid && (
                        ...
                        >
                          <XCircle size={16} /> Peso Final não pode ser menor que o Peso de Entrada
                    ...
                    <div style={{ display: 'flex', gap: 16 }}>
                      ...
                      >
                        ...
                        <div
                          style={{
                            ...
                            fontWeight: 900,
                            color:
                              fechamentoStats.gmdRealizado >= 1.5
                                ? '#10b981'
                                : fechamentoStats.gmdRealizado >= 1.0
                                  ? 'hsl(var(--brand))'
                                  : '#f59e0b',
                          }}
                        >
                          {fechamentoStats.gmdRealizado.toFixed(3)}{' '}
                          <span style={{ fontSize: 12, fontWeight: 700 }}>kg/d</span>
                        </div>
                      </div>
                      <div
                        style={{
                      ...
                      >
                        ...
                        <div
                          style={{ fontSize: 20, fontWeight: 900, color: 'hsl(var(--text-main))' }}
                        >
                          +{fechamentoStats.arrobasProduzidas.toFixed(1)}{' '}
