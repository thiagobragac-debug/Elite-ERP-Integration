    ...
    >
      ...
      >
        ...
        <div className="tauze-sidebar-body">
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Tipologia Mecânica <Settings size={14} />
            </label>
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Custo TCO Acumulado <DollarSign size={14} />
            </label>
            <div
            ...
            >
              ...
              >
                <span style={{ fontSize: '22px', fontWeight: 900, color: '#ed6c02' }}>
                  {filters.maxCost.toLocaleString('pt-BR')}
                </span>
                <span
          ...
          <div className="tauze-filter-section">
            <label className="tauze-filter-label">
              Período de Intervenção <Calendar size={14} />
            </label>
        ...
        <div className="tauze-sidebar-footer">
          ...
          <button
            ...
            style={{ flex: 1, background: '#ed6c02' }}
            onClick={onClose}
          >
            APLICAR
          </button>
